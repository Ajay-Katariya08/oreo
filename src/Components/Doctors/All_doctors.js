...
function All_doctors(){
    ...
    useEffect(() => {
        axios.get('http://localhost/oreo/Add_doctor.php')
                        ...
                        <div class="row clearfix">
                            {
                                data.map((i,k)=>{
                                    return(
                                        <>
                                         <div class="col-lg-3 col-md-4 col-sm-6" key={k}>
                                <div class="card xl-blue member-card doctor">
                                    <div class="body">
                                        <div class="member-thumb">
                                            <img src={i.image} class="img-fluid" alt="profile-image" />                               
                                        </div>
                                        <div class="detail">
                                            <h4 class="m-b-0">{i.Fname}</h4>
